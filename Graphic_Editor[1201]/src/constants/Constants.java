...
//		MagnifyingGlass("rsc/magnifyingGlass.png", "rsc/magnifyingSelected.PNG", new Rectangle());
	...
	public static enum EDialogButton {
		check("확인"), 
		save("저장"), 
		donsave("저장 안함"), 
		cancel("취소");
		...
		private EDialogButton(String label){
			this.label = label;
		}
	...
	public enum EState {idle, drawingNP, drawingTP, Transforming, fill, copy, copyAfter, undo, paste};
	public enum ESelectedTool {rectangle, line, text, polygon, pencil};
	...
	public enum ESave {saved, unsaved}
	public enum EOpen {opened, unopened}
	public enum EFileButton {New, Open, Exit}
