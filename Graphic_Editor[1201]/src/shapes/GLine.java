...
public class GLine extends GShape{
	...
	public void move(int x, int y) {
		this.line.setLine(this.line.getX1()+(x-ex), this.line.getY1()+(y-ey), this.line.getX2()+(x-ex), this.line.getY2()+(y-ey));
		this.setPoint(x, y);
	}
	...
	public void resize(int x, int y) {
		if(this.getCurrentEAnchor() == null){
			this.line.setLine(this.line.getX1(), this.line.getY1(), x-ex, y-ey);
			return;
		}
		...
		case SS:
			break;
		case SE:
			this.line.setLine(this.line.getX1(), this.line.getY1(), this.line.getX2()+(x-ex), this.line.getY2()+(y-ey));
			break;
		case SW:
			break;
		case EE:
