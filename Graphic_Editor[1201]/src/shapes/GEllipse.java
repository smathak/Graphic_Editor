...
public class GEllipse extends GShape{
	...
	public void move(int x, int y) {
		this.ellipse.setFrame(this.ellipse.getX()+(x-ex), this.ellipse.getY()+(y-ey), this.ellipse.getWidth(), this.ellipse.getHeight());
		this.setPoint(x, y);
	}
	@Override
	public void resize(int x, int y) {
		if(this.getCurrentEAnchor() == null){
			double width = x - this.ellipse.getX();
			double height = y - this.ellipse.getY();
			this.ellipse.setFrame(this.ellipse.getX(), this.ellipse.getY(), width, height);
			return;
		}
		...
		case SS:
			break;
		case SE:
			double width = this.ellipse.getWidth()+(x-ex);
			double height = this.ellipse.getHeight()+(y-ey);
			this.ellipse.setFrame(this.ellipse.getX(), this.ellipse.getY(), width, height);			
			break;
		case SW:
			break;
